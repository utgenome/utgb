...
public class UTGBWidgetTest implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		canvas.beginPath();
		canvas.arc(75, 75, 50, 0, (float) (Math.PI * 2), true); // äOÇÃâ~
		canvas.moveTo(110, 75);
		canvas.arc(75, 75, 35, 0, (float) Math.PI, false); // å˚ (éûåvâÒÇË)
		canvas.moveTo(65, 65);
		canvas.arc(60, 65, 5, 0, (float) (Math.PI * 2), true); // ç∂ñ⁄
		canvas.moveTo(95, 65);
		canvas.arc(90, 65, 5, 0, (float) (Math.PI * 2), true); // âEñ⁄
		canvas.stroke();
