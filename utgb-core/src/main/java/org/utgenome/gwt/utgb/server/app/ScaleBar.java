...
public class ScaleBar extends WebTrackBase
{
    ...
    /**
     * Describe your web action parameters here.
     * Public fields in this class will be set using the web request query parameters before calling handle().
     */
     
    /**     
     * Predefined coordinate parameters for GenomeTrack. 
     * Uncomment the following lines if you want to receive these parameter values.
     */
