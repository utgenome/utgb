...
/**
 * {@link CSS} is a helper class to edit CSS (Cascading Style Sheet) design
 * 
 * @author leo
 * 
 */
public class CSS {
	...
	/**
	 * set the overlap position of the widget. Widgets with the higher z-index will be front on the
	 * display
	 * 
	 * @param w
	 *            the widget
	...
	public static final String	CSS_BORDER_COLLAPSE	= "border-collapse";
